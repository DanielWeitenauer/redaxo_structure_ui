...
<li class="article">
  <div>
    ...
    <span class="right trigger_modal">
      <a href="<?php echo rex_url::backendPage('structure',['id'=>$articleId, 'clang'=>rex_clang::getCurrent()->getId(),'function'=>'edit','type'=>'art']);?>" data-modal="true" data-target="#modal_structure">Einstellungen</a>
